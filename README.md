...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1738231645) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-tabler-1738231645.git
$ cd django-tabler-1738231645
```
